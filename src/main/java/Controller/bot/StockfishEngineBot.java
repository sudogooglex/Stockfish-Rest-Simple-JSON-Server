 ...
 */
@Data
public class StockfishEngineBot {

    private Process engineProcess;
    private BufferedReader processReader;
    private OutputStreamWriter processWriter;
// Server Input and Output
    private OutputBeanBot outputBean;
    private InputBeanBot inputBean;

    public StockfishEngineBot(InputBeanBot ib) {
        inputBean = ib;
        outputBean = new OutputBeanBot(ib.getForsythEdwardsNotation());
    }
